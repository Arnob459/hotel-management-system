...
@push('button')
<a href="{{ route('admin.room.create') }}" class="btn btn-lg btn-warning ">Add New</a>
@endpush
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('admin.room.edit',$item->id) }}"  class="btn btn-primary rounded-pill"  ><i class ="fa fa-edit"></i> Edit</a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form method="POST" action="{{ route('admin.room.destroy', $item->id) }}">
                                                    @csrf
                                                    @method('DELETE')
