...
@push('button')
<a href="{{ route('admin.offer.create') }}" class="btn btn-lg btn-warning ">Add New</a>
@endpush
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-bold-500">
                                        ...
                                        <img class="avatar-img rounded-circle" src="{{ asset('assets/images/offer/'.$item->image) }}" >
                                        </div>
                                    </td>
                                    <td class="text-bold-500">{{ $item->title }}</td>
                                    <td class="text-bold-500">{{ $item->date }}</td>
                                    <td class="text-bold-500">{{ $item->section }}</td>

                                    <td class="text-bold-500">{{ $item->short_text }}</td>
                                    <td>
                                        <a  href="{{ route('admin.offer.edit',$item->id) }}"  class="btn btn-primary rounded-pill"  ><i class ="bi bi-pencil">Edit</i></a>
