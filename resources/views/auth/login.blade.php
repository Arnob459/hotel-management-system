                ...
                <div class="col-lg-6 offset-lg-3">
                    <div class="de-content-overlay">
                        {{-- <form name="contactForm" id='contact_form' method="post"> --}}
                            <form method="POST" id='contact_form' action="{{ route('login') }}">
                                @csrf
                            ...
                            <div id="step-2" class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div>
                                        <input id="password" type="text" class="form-control @error('password') is-invalid @enderror" placeholder="Your Password" name="password" required autocomplete="current-password">
                                ...
                                <div class="col-md-12">
                                    <p id='submit' class="mt20">
                                        <input type='submit'  class="btn btn-line">
                                    </p>
                                </div>
                            </div>
                        </form>
